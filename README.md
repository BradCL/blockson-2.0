...
[![CI](https://github.com/BradCL/blockson-2.0/actions/workflows/ci.yml/badge.svg)](https://github.com/BradCL/blockson-2.0/actions/workflows/ci.yml)
...
**[Try the live demo →](https://bradcl.github.io/blockson-2.0/)** — the real
click-to-edit editor running entirely in your browser (no install, no server;
only Publish is disabled), plus the example sites the engine builds.

[![The click-to-edit editor open on the demo site: the site preview on the left, the field editor, blueprint menu, and brand-color controls on the right](docs/img/editor-demo.png)](https://bradcl.github.io/blockson-2.0/demo/)

## Where to go

| You want to… | Go to |
|--------------|-------|
| See it working in 90 seconds | [Live demo](https://bradcl.github.io/blockson-2.0/) |
| Build a site on your machine | [Quick start](#quick-start) below |
| The invariants and the patch contract | [SPEC.md](SPEC.md) |
| Deploy for a client and hand over | [OPERATOR.md](OPERATOR.md) |
| Every block type, field by field | [BLOCK_CATALOG.md](BLOCK_CATALOG.md) |
| Learn the codebase in depth | [Learning guide](docs/learning-guide/) · [developer tutorial](docs/tutorial/developer/README.md) · [owner tutorial](docs/tutorial/owner/README.md) |
...
engine/
  ...
  _run-proofs.js        End-to-end proof suite (32 proofs)
...
the validators and the proof suite, not by how any part was authored. Every
business in the example clients is fictional and every photo is AI-generated.

...
`engine/_run-proofs.js` — one file, 25 "proofs," run by `npm test`.
...
this affordable: 25 full-system proofs, including real builds, real
...
`25/25 proofs passed.` The suite exercises the example clients, the

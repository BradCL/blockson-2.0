...
`engine/_run-proofs.js` — one file, 24 "proofs," run by `npm test`.
...
this affordable: 24 full-system proofs, including real builds, real
...
`24/24 proofs passed.` The suite exercises the example clients, the
